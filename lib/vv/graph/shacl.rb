...
module Vv::Graph
  # PLAN_0.10.0 — `Vv::Graph::Shacl` — SHACL Core constraint validation.
  #
  ...
  #   #          source_shape: "<urn:vv-graph:shape:Product/gtin>",
  ...
  module Shacl
    ...
    # per-kwarg trio or a `scope:` (Vv::Graph::Scope). Scope's
